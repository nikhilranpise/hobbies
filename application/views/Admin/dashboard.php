                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                         ...
                         <tr>
                          ...
                          <td><?php echo $u->hobbies_count; ?></td> 
                          <td>
                            <a href="<?php echo base_url();?>hobbies_view/<?php echo $u->user_id; ?>" style="padding-left: 5px;padding-right: 5px;"  title="View All Hobbies" ><img src="<?php echo base_url();?>assets/images/eye.png" height="25px" width="25px"></a>
                          </td>
                        </tr>
                        <?php $i++;} ?>
                      </tbody>
