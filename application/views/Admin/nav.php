            ...
            <div class="row align-items-center">
              <div class="col-lg-1 ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow">
                      ...
                      <a href="<?php echo base_url();?>logoutAdmin" class="dropdown-item ">Logout</a>
                    </div>
                  </li>
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  <li class="nav-item dropdown">
                    <a href="<?php echo base_url();?>adminDashboard"  class="nav-link <?php echo ((isset($master_class) && $master_class == 'Dashboard') ?  'active' : ''); ?>"><i class="fa fa-dashboard"></i>Dashboard</a>
                  </li> 
